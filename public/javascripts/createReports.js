...
equipmentSelect.onchange = function(event){
  var equipmentid = event.target.options[event.target.selectedIndex].dataset.equipmentid;
...
specialtySelect.onchange = function(event){
  var specialtyId = event.target.options[event.target.selectedIndex].dataset.specialtyid;
